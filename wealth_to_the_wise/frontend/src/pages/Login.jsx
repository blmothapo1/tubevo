...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-32 w-96 h-96 bg-brand-600/8 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -right-32 w-80 h-80 bg-accent-500/6 rounded-full blur-3xl pointer-events-none" />
