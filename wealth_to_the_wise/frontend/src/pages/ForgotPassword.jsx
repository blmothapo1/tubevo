    ...
    <div className="min-h-screen bg-surface-50 flex items-center justify-center px-5 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-sm text-surface-600">Reset your password</p>
        </div>
        ...
        {sent ? (
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-brand-500/15 flex items-center justify-center mx-auto">
