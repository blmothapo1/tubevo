...
const tiers = [
  {
    ...
    price: '$0',
    period: '/mo',
    features: ['3 videos/month', '1 niche', 'Basic analytics', 'Watermark on thumbnails'],
  ...
  },
  {
    ...
    price: '$29',
    period: '/mo',
    features: ['30 videos/month', '3 niches', 'Full analytics', 'Custom thumbnails', 'Priority rendering', 'Scheduling'],
    cta: 'Start Pro Trial',
    popular: true,
  },
  {
    ...
    price: '$99',
    period: '/mo',
    features: ['Unlimited videos', 'Unlimited niches', '5 channels', 'Team access', 'API access', 'White-label'],
    cta: 'Contact Sales',
    popular: false,
  },
];
